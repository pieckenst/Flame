    ...
    run(message, args) {
        return message.channel.send(
            new MessageEmbed()
                ...
                .setColor('ffa500')
                .setDescription(`**Flame** — это многофункциональный бот на платформе Discord, созданный с целью объеденить функционал многих ботов в одного. Бот имеет множество полезных возможностей, которые подойдут практически для любого сервера: начиная от модерации, заканчивая интересной экономикой. Помимо этого проект активно обновляется, и с каждой неделей бот наполняется новыми функциями.`)
                .addField(
                    'Основные ресурсы', 
